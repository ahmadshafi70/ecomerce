...
Route::get('facebook/{id}','FrontendController@facebook')->name('facebook');
...
Route::group(['prefix'=>'/admin','middleware'=>['auth','admin']],function(){
    ...
    Route::resource('/show/','ProductController@show');
    ...
    Route::post('/orderadd','OrderController@add')->name('order.add');
    Route::post('order/save/{id}','OrderController@save')->name('order.save');
    Route::get('order/search/{slug}','OrderController@search')->name('order.search');
