...
return [
    ...
    */
    ...
    'github' => [
     ...
     'google' => [
        'client_id' => '678493714546-27ckkqsvosbasvv85nkn1bf24dsqs8ot.apps.googleusercontent.com', //Google API
        'client_secret' => '3P2KIyr-QoyZWW42XeDakM0H', //Google Secret
        'redirect' => 'http://localhost/ecomerce/public/login/google/callback',
     ],
     'facebook' => [
