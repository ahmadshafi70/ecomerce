...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address" style="margin-top: 100px;">
      

      <p>Phone: <a href="tel:{{$settings->phone}}">{{env('APP_PHONE')}}</a></p>
      <p>Email: <a href="mailto:{{$settings->email}}">{{$settings->email}}</a></p>
      <p>Address: <a href="mailto:{{$settings->email}}">{{$settings->address}}</a></p>
    </div>
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>PKR{{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>PKR{{number_format($order->sub_total,2)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>PKR{{number_format($shipping_charge[0],2)}}</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
