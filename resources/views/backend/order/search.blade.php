...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <h5 class="m-0 font-weight-bold text-primary float-left">All <span style="color:red; ">{{ ucwords($status)}}</span> Order Lists</h5>
    </div>
            ...
            @endphp 
              <a href="#" >
                <tr>
                    ...
                    <td>
                      @if($order->status=='new')
                        <span class="badge badge-primary"><i class="fas fas-plus-circle" aria-hidden="true"></i>{{$order->status}}</span>
