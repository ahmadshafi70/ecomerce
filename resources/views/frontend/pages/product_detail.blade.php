...
@section('meta')
	...
	<meta property="og:title" content="{{$product_detail->title}} in PKR {{$product_detail->price}}">
										...
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @foreach($socialshare as $key => $value)
			                                     ...
			                                     <a class="icon-{{$key}}" href="{{$value}}">{{$key}}</a>	
			                                    @endforeach	
                                                @php 
																...
																<div class="ratting-main">
																	...
																	<div class="single-rating">
																		<div class="rating-author">
																			...
																			@else 
																			<img src="{{asset('/')}}/{{asset('backend/img/avatar.png')}}" alt="Profile.jpg">
																			@endif
																		</div>
