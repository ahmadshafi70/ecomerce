								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<   tr>
											...
											<td class="price" data-title="Price"><span>PKR{{number_format($cart['price'],2)}}</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">PKR {{$cart['amount']}}</span></td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">You Pay<span>PKR{{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">You Pay<span>PKR{{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
